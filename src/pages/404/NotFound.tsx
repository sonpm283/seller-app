  ...
  return (
    <Box sx={{
      ...
      <Box sx={{
        ...
        <Typography variant='h2' sx={{ fontSize: '18px !important', lineHeight: '25px', fontWeight: 400, maxWidth: '350px', textAlign: 'center' }}>
          LOST IN&nbsp;
          ...
          &nbsp;<Typography variant="body1" sx={{ color: '#fdba26', fontWeight: 500 }}>Seller App</Typography>?<br />Hmm, looks like that page doesn&apos;t exist.
        </Typography>
